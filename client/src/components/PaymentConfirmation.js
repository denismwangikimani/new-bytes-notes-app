...
function PaymentConfirmation() {
  ...
  useEffect(() => {
    ...
    if (redirectStatus === 'succeeded') {
      ...
      axios.post('https://new-bytes-notes-backend.onrender.com/register/complete', {
        email,
        paymentIntentId
      })
      .then(response => {
      ...
      .catch(error => {
        setStatus('error');
        setMessage('Payment was successful, but account activation failed. Please contact support.');
      ...
      <div className="payment-confirmation-card">
        ...
        {status === 'success' && (
          <>
            ...
            <p>{message}</p>
            <p className="redirect-message">You will be redirected to your notes in a moment...</p>
          </>
        )}
